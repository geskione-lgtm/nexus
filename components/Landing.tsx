      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md z-50 border-b border-slate-100">
        <div className="flex items-center justify-between px-8 py-3 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={onRegister}
              className="bg-[#2563eb] text-white px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-[#1d4ed8] transition-all shadow-md"
            >
              Hemen Başla
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <button
                onClick={onRegister}
                className="bg-[#2563eb] text-white px-10 py-5 rounded-full font-bold flex items-center gap-3 hover:scale-105 transition-transform shadow-floating hover:bg-[#1d4ed8]"
              >
                Hemen Başla
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-64 h-64 border border-white/10 rounded-full flex items-center justify-center">
                        <div className="w-48 h-48 border border-primary/20 rounded-full animate-[spin_10s_linear_infinite] border-t-primary"></div>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {PACKAGES.map((pkg) => (
              <div key={pkg.id} className="bg-white p-12 rounded-[48px] border border-border-subtle shadow-soft hover:shadow-floating transition-all hover:-translate-y-2 group">
                ...
                <button onClick={onRegister} className="w-full py-5 rounded-3xl bg-[#2563eb] text-white font-bold uppercase tracking-widest text-xs hover:bg-[#1d4ed8] transition-colors shadow-lg shadow-primary/20">
                  Hemen Başlat
                </button>
              </div>
            ))}
