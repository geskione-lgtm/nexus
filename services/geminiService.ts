...
export async function generateBabyFace(ultrasoundBase64: string, highRes: boolean = false): Promise<string> {
  ...
  const prompt = `
    Analyze the ultrasound scan. Generate a hyper-realistic, medical-grade 3D studio visualization of the baby's face.
